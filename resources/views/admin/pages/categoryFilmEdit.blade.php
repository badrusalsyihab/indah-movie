...
<div class="app-wrapper">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">	
			    ...
			    <h1 class="app-page-title">Kategori Film Edit</h1>
			    <hr class="mb-4">
                <div class="row g-4 settings-section">
	                <div class="col-12 col-md-4">
		                <h3 class="section-title">Form</h3>
		                <div class="section-intro">Anda dapat Edit kategori film pada form input berikut </div>
	                </div>
...
@endif
						    ...
						    <div class="app-card-body">
							    <form action="{{route('adminDashboardCategoryFilmStore')}}" method="post" class="settings-form">
								    <div class="mb-3">
  ...
  <circle cx="8" cy="4.5" r="1"/>
									    ...
									    <input type="text" name="name" class="form-control" value="{{ $edit['namaKategori'] }}" id="setting-input-1">
                                        <input type="hidden" name="id" class="form-control" value="{{ $edit['idKategori'] }}" id="setting-input-1">
