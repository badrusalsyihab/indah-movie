	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    ...
			    <div class="row g-3 mb-4 align-items-center justify-content-between">
				    <div class="col-auto">
			            <h1 class="app-page-title mb-0">List Ikut Casting</h1>
				    </div>
                    <div class="col-auto">
					     <div class="page-utilities">
						    <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
							    <div class="col-auto">
								    <form action="{{ route('adminDashboardCastingTransactionSearch') }}" method="post" class="table-search-form row gx-1 align-items-center">
					                    <div class="col-auto">
							        ...
							        <table class="table app-table-hover mb-0 text-left">
										<thead>
											<tr>
												...
												<th class="cell">Pengajuan Karakter</th>
										...
										<tbody>
											...
											<tr>
												<td class="cell">{{$list['idTrxCasting']}}</td>
												<td class="cell"><span class="truncate">{{$list['master_peserta_casting']['nama']}}</span></td>
												<td class="cell">{{$list['master_film']['judulFilm']}}</td>
												<td class="cell">{{$list['pengajuanKarakter']}}</td>
												<td class="cell">
                                                ...
                                                @if($list['statusTransaksi'] == "Menunggu")
                                                    <a class="btn-sm app-btn-secondary" href="{{ route('adminDashboardCastingDetailTransaction', $list['idTrxCasting']) }}">Update Status</a>
                                                @else
