<header class="app-header fixed-top">	   	            
		        ...
		        <div class="app-header-content"> 
		            ...
		            <div class="app-utilities col-auto">
			            ...
			            <div class="app-utility-item app-user-dropdown dropdown">
				            <a class="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">hai, {{auth('pegawai')->user()->namaPeg}}</a>
				            <ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle">
								<li><a class="dropdown-item" href="{{ route('frontPegawaiLogout') }}">Log Out</a></li>
							</ul>
        ...
        <div id="app-sidepanel" class="app-sidepanel"> 
	        ...
	        <div class="sidepanel-inner d-flex flex-column">
		        ...
		        <div class="app-branding">
		            <a class="app-logo" href="{{route('adminDashboard')}}"><img class="logo-icon me-2" src="assets/images/app-logo.svg" alt="logo"><span class="logo-text">PORTAL</span></a>
	  ...
	  <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
					        ...
					        <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
								...
								<li class="submenu-item"><a class="submenu-link" href="{{route('adminDashboardPegawai')}}">Pegawai</a></li>
								<li class="submenu-item"><a class="submenu-link" href="{{route('adminDashboardCasting')}}">Peserta Casting</a></li>
								<li class="submenu-item"><a class="submenu-link" href="{{route('adminDashboardSponsor')}}">Member Sponsor</a></li>
