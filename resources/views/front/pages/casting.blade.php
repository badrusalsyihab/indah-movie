            ...
            <div class="row">
                ...
                <div class="col-lg-4 mb-5">
                    <div class="card border-0 bg-light shadow-sm pb-2">
                        ...
                        @if($list['statusCasting'] == 'Close')
                        <a href="" class="btn btn-primary px-4 mx-auto mb-4 disabled">Join Now</a>
                        @else
                        <a href="{{route('frontCastingForm', ['film' => $list['judulFilm']])}}" class="btn btn-primary px-4 mx-auto mb-4">Join Now</a>
                        @endif
                    </div>
                </div>
                @endforeach
