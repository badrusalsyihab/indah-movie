...
@endif
			        <div class="auth-form-container text-start">
						<form action="{{ route('frontSponsorLoginStore') }}" method="post" class="auth-form login-form">         
						...
						<div class="auth-option text-center pt-5">No Account? Sign up <a class="text-link" href="{{route('frontSponsorSignUp')}}" >here</a>.</div>
